  ...
  return (
    <div className="space-y-5 animate-fade-in" id="engine-station-container">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-4 rounded-xl flex flex-col items-center justify-around min-h-[170px]">
          <div className="text-center">
            <span className="text-[10px] font-mono text-slate-400 uppercase tracking-wider block">JACKET TEMPERATURE</span>
            <span className="font-display text-sm font-semibold text-orange-400 uppercase">Jacket Temp</span>
          </div>
